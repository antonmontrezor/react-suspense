...
The users don't need to worry about the loading and error states as they are processed in the hook, but the users are anyway responsible to handle those states in terms of UI rendered like Suspense fallback and error boundaries
